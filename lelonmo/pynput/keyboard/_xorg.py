...
try:
    from lelonmo import pynput._util.xorg
...
from lelonmo.pynput._util import NotifierMixin
from lelonmo.pynput._util.xorg import (
    alt_mask,
    alt_gr_mask,
    char_to_keysym,
    display_manager,
    ...
    shift_to_index,
    symbol_to_keysym)
from lelonmo.pynput._util.xorg_keysyms import (
    CHARS,
    DEAD_KEYS,
    KEYPAD_KEYS,
    KEYSYMS,
